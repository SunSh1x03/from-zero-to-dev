...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-black relative overflow-hidden">
      ...
      <div className="absolute top-40 right-20 w-24 h-24 bg-purple-500 rounded-lg opacity-20 blur-xl animate-pulse" style={{ animationDelay: '0.5s' }}></div>
      <div className="absolute bottom-20 left-1/4 w-40 h-40 bg-pink-500 opacity-20 blur-xl animate-spin" style={{ animationDuration: '10s' }}></div>
      <div className="absolute bottom-40 right-1/3 w-20 h-20 bg-yellow-500 rounded-full opacity-20 blur-xl animate-bounce" style={{ animationDelay: '1s' }}></div>
        ...
        <div className="max-w-4xl w-full">
          ...
          <div className="flex justify-center mb-8">
            <div className="relative">
              ...
              <div className="relative bg-gradient-to-br from-gray-800 to-gray-900 rounded-3xl p-8 shadow-2xl border border-cyan-500/30 transform hover:scale-110 transition-transform duration-300">
                <ActiveIconComponent className="w-20 h-20 text-cyan-400" strokeWidth={2} />
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            <div className="bg-gradient-to-br from-gray-800 to-gray-900 border border-purple-500/30 rounded-2xl p-6 shadow-xl transform hover:rotate-3 hover:border-purple-500/60 transition-all hover:shadow-purple-500/20">
              ...
              <h3 className="text-lg font-bold text-gray-100 mb-2">Codando Muito</h3>
              <p className="text-gray-400">Linha por linha, fazendo mágica acontecer! 💻</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-gray-800 to-gray-900 border border-yellow-500/30 rounded-2xl p-6 shadow-xl transform hover:rotate-3 hover:border-yellow-500/60 transition-all hover:shadow-yellow-500/20">
              ...
              <h3 className="text-lg font-bold text-gray-100 mb-2">Design Top</h3>
              <p className="text-gray-400">Cores neon e interface cinematográfica! 🎨</p>
            </div>
          ...
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 border border-cyan-500/30 rounded-2xl p-8 shadow-xl mb-8 shadow-cyan-500/10">
            <div className="flex items-center justify-between mb-4">
              <span className="text-2xl font-black bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent">Progresso</span>
      ...
      <div className="fixed inset-0 pointer-events-none">
        <div className="absolute top-10 left-10 text-4xl animate-bounce drop-shadow-[0_0_10px_rgba(6,182,212,0.8)]">🎨</div>
        <div className="absolute top-20 right-20 text-4xl animate-bounce drop-shadow-[0_0_10px_rgba(168,85,247,0.8)]" style={{ animationDelay: '0.5s' }}>💻</div>
        <div className="absolute bottom-20 left-20 text-4xl animate-bounce drop-shadow-[0_0_10px_rgba(236,72,153,0.8)]" style={{ animationDelay: '1s' }}>🚀</div>
        <div className="absolute bottom-10 right-10 text-4xl animate-bounce drop-shadow-[0_0_10px_rgba(234,179,8,0.8)]" style={{ animationDelay: '1.5s' }}>⚡</div>
      </div>
    </div>
  );
}